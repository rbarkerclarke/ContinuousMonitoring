...
```{r}
model1=glm(formula = stay_hrs ~ mino2 +MAP_q0+o2_q0+o2_outlier + map_outlier + bmi+o2_q50+T1+T2+T3+`Duration of surgery (hours)`+pacu_los_hr, data = patient_summary %>% mutate(across(c(stay_hrs, age, bmi,
